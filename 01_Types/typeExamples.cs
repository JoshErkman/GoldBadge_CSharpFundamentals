...
namespace _01_Types
{
    ...
    public class typeExamples
    {
        ...
        public void ValueTypes()
        {
            ...
            Int64 anotherLargeNumber;

            //--Decimals
            float floatExample = 1.234567f;
            double doubleExample = 1.234589;
            decimal decimalExample = 1.65643m;
        ...
        public void ReferenceTypes()
        {
            ...
            //--Formatting strings
            string concatenate = stringExample + name; //This is a string.Josh
            string concatenateWithSpace = stringExample + " " + name; //This is a string. Josh
            string interpolate = $"{name}. Here is the string: {stringExample}"; //Josh. Here is the string: This is a string.
            Console.WriteLine(concatenateWithSpace);
